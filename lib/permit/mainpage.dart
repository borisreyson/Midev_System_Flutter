...
import 'package:midev_system_fl/permit/page/home_page.dart';
import 'package:midev_system_fl/permit/page/news.dart';
import 'package:midev_system_fl/permit/page/profile.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  final List<Widget> _listPage = [const HomePage(), const News(), const Profile()];
